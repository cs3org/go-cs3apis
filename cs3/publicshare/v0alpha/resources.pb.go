...
import (
	fmt "fmt"
	v0alpha1 "github.com/cernbox/go-cs3apis/cs3/shareregistry/v0alpha"
...
type ProviderInfo struct {
	...
	ShareType v0alpha1.ShareType `protobuf:"varint,2,opt,name=share_type,json=shareType,proto3,enum=cs3.shareregistryv0alpha.ShareType" json:"share_type,omitempty"`
	// REQUIRED.
...
func (m *ProviderInfo) GetShareType() v0alpha1.ShareType {
	if m != nil {
		return m.ShareType
	}
	return v0alpha1.ShareType_SHARE_TYPE_INVALID
}
...
type PublicShareId struct {
	// REQUIRED.
	// The share type.
	Type v0alpha1.ShareType `protobuf:"varint,1,opt,name=type,proto3,enum=cs3.shareregistryv0alpha.ShareType" json:"type,omitempty"`
	// REQUIRED.
...
func (m *PublicShareId) GetType() v0alpha1.ShareType {
	if m != nil {
		return m.Type
	}
	return v0alpha1.ShareType_SHARE_TYPE_INVALID
...
var fileDescriptor_295bc0932a0a29ce = []byte{
	...
	,
}
