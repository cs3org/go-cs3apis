...
const (
	UserAPI_CreateUser_FullMethodName = "/cs3.admin.user.v1beta1.UserAPI/CreateUser"
	UserAPI_DeleteUser_FullMethodName = "/cs3.admin.user.v1beta1.UserAPI/DeleteUser"
)
