...
type GetStorageProviderResponse struct {
	...
	Provider             *v0alpha.ProviderInfo `protobuf:"bytes,3,opt,name=provider,proto3" json:"provider,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *GetStorageProviderResponse) GetProvider() *v0alpha.ProviderInfo {
	if m != nil {
		return m.Provider
	}
	return nil
...
type ListStorageProvidersResponse struct {
	...
	Providers            []*v0alpha.ProviderInfo `protobuf:"bytes,3,rep,name=providers,proto3" json:"providers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *ListStorageProvidersResponse) GetProviders() []*v0alpha.ProviderInfo {
	if m != nil {
		return m.Providers
	}
	return nil
...
var fileDescriptor_28eee549603e3a86 = []byte{
	...
	,
}
