...
type Lock struct {
	// The type of lock.
	Type LockType `protobuf:"varint,1,opt,name=type,proto3,enum=cs3.storage.provider.v1beta1.LockType" json:"type,omitempty"`
	// The entity holding the lock.
	//
	// Types that are valid to be assigned to Holder:
	//	*Lock_User
	//	*Lock_AppName
	Holder isLock_Holder `protobuf_oneof:"holder"`
	...
	Mtime                *v1beta1.Timestamp `protobuf:"bytes,5,opt,name=mtime,proto3" json:"mtime,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
type isLock_Holder interface {
	isLock_Holder()
}

type Lock_User struct {
	User *v1beta11.UserId `protobuf:"bytes,2,opt,name=user,proto3,oneof"`
}

type Lock_AppName struct {
	AppName string `protobuf:"bytes,3,opt,name=app_name,json=appName,proto3,oneof"`
}

func (*Lock_User) isLock_Holder() {}

func (*Lock_AppName) isLock_Holder() {}

func (m *Lock) GetHolder() isLock_Holder {
	if m != nil {
		return m.Holder
	}
	return nil
...
func (m *Lock) GetUser() *v1beta11.UserId {
	if x, ok := m.GetHolder().(*Lock_User); ok {
		return x.User
	}
	return nil
}
...
func (m *Lock) GetAppName() string {
	if x, ok := m.GetHolder().(*Lock_AppName); ok {
		return x.AppName
	}
	return ""
}

func (m *Lock) GetMetadata() string {
	if m != nil {
		return m.Metadata
	}
	return ""
...
func (m *Lock) GetMtime() *v1beta1.Timestamp {
	if m != nil {
		return m.Mtime
	}
	return nil
...
func (*Lock) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Lock_User)(nil),
		(*Lock_AppName)(nil),
	}
...
var fileDescriptor_b91600c359c2e479 = []byte{
	...
	,
}
