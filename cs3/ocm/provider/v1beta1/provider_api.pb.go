...
type IsProviderAllowedRequest struct {
	...
	// REQUIRED.
	// The user whose system provider we need to verify.
...
func (m *IsProviderAllowedRequest) GetUser() *v1beta11.User {
	if m != nil {
		return m.User
	}
	return nil
...
func (m *IsProviderAllowedResponse) GetStatus() *v1beta12.Status {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *GetInfoByDomainResponse) GetStatus() *v1beta12.Status {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *ListAllProvidersResponse) GetStatus() *v1beta12.Status {
	if m != nil {
		return m.Status
	}
	return nil
...
var fileDescriptor_f9d7362468fbd522 = []byte{
	...
	,
}
